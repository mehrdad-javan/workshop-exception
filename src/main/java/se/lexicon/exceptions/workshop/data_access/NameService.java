...
public class NameService {
	    ...
	    public void addFemaleFirstName(String name) {
			...
			if (femaleFirstNames.contains(name)) throw new DuplicateNameException("Sorry! could not add " + name +" already exists in list!");
	    ...
	    public void addLastName(String lastName) {
			...
			if (lastNames.contains(lastName)) throw new DuplicateNameException("Sorry! could not add " + lastName +" already exists in list!");
